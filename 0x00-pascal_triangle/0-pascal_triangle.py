...
def pascal_triangle(n):
    ...
    representing the Pascal's triangle of num_rows.
    ...
    for current_row in range(1, n):
        ...
        for current_element in range(1, len(p_row)):
            new_row.append(
                    p_row[current_element - 1] + p_row[current_element]
                    )
